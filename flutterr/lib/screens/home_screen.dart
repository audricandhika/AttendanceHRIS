      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            ...
            // MENU GRID — PAKAI Navigator.pushNamed (ROUTE BIASA!)
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildListDelegate([
                  _buildMenuCard(
                    ...
                    title: 'Absensi',
                    subtitle: 'Clock In, Clock Out & Lembur',
                  ...
                  _buildMenuCard(
                    ...
                    title: 'Kelola Izin',
                    subtitle: 'Pengajuan & approval',
                    color: const Color(0xFF2196F3),
                    onTap: () => Navigator.pushNamed(context, '/kelola_izin'),
                  ),
                  _buildMenuCard(
                    context,
                    icon: Icons.people,
